...
import { GetPersonsDiedDsc } from '../../../lib/persondata_api'

export const getStaticProps: GetStaticProps = async (_context) => {
  
  const persons: PersonSummaryData[] = await GetPersonsDiedDsc()
...
<script src="https://unpkg.com/react/umd/react.production.min.js" crossOrigin async></script>
    ...
    <Breadcrumb.Item active >Order: Death date - Descending</Breadcrumb.Item>
   
</Breadcrumb> 
<PersonNav/>
      
      <h3>Order: Death date - Descending </h3>
