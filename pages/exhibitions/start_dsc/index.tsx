...
import { GetExsStartDsc } from '../../../lib/exhibitiondata_api'
 
export const getStaticProps: GetStaticProps = async (_context) => {
  
  const exs: ExSummaryData[] = await GetExsStartDsc()
...
<script src="https://unpkg.com/react/umd/react.production.min.js" crossOrigin async></script>
    ...
    <Breadcrumb.Item active >Order: Start date - Descending</Breadcrumb.Item>
   
</Breadcrumb> 

<ExNav/>
     
           <h3>Order: Start date - Descending</h3>
