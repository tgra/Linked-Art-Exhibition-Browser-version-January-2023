...
import { GetExsStartAsc } from '../../../lib/exhibitiondata_api'
 
export const getStaticProps: GetStaticProps = async (_context) => {
  
  const exs: ExSummaryData[] = await GetExsStartAsc()
...
<script src="https://unpkg.com/react/umd/react.production.min.js" crossOrigin async></script>
    ...
    <Breadcrumb.Item active >Order: Start date - Ascending</Breadcrumb.Item>
   
</Breadcrumb> 

<ExNav/>
     
           <h3>Order: Start date - Ascending </h3>
