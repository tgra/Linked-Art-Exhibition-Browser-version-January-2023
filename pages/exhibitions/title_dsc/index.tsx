...
import { GetExsTitleDsc } from '../../../lib/exhibitiondata_api'
 
export const getStaticProps: GetStaticProps = async (_context) => {
  
  const exs: ExSummaryData[] = await GetExsTitleDsc()
...
<script src="https://unpkg.com/react/umd/react.production.min.js" crossOrigin async></script>
    ...
    <Breadcrumb.Item active >Order: Exhibition Title - Descending</Breadcrumb.Item>
   
</Breadcrumb> 

<ExNav/>
     
           <h3>Order: Exhibition Title - Descending</h3>
